      ...
      <Stack spacing={3}>
        ...
        >
          {[
            ...
            <Stack key={step.num} direction={{ xs: 'row', md: 'row' }} alignItems="center" sx={{ flex: 1 }}>
              <motion.div
              ...
              >
                <Stack direction="row" alignItems="center" spacing={1.5}>
                  ...
                  <Typography variant="body2" sx={{ color: 'text.secondary', maxWidth: 140 }}>
                    {step.label}
                  </Typography>
                </Stack>
              </motion.div>
              {i < 2 && (
                <Divider
                  ...
                  flexItem
                  sx={{ display: { xs: 'none', md: 'block' }, flex: 1, mx: 1.5, borderStyle: 'dashed' }}
                />
              )}
            </Stack>
          ))}
        ...
        <Paper variant="outlined" sx={{ p: 3 }} data-tour="import-dropzone">
          <Stack spacing={3}>
            ...
            <motion.div whileHover={(!hasSubscription || isImportBlocked) ? {} : { scale: 1.01 }} transition={{ duration: 0.15 }}>
            <Box
              sx={{
                border: '2px dashed',
