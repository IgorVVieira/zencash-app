        ...
        variants: [
          ...
          },
          {
            ...
            style: {
              ...
              boxShadow: `inset 0 1px 0 ${brand[300]}, 0 2px 8px ${alpha(brand[600], 0.35)}`,
              border: `1px solid ${brand[600]}`,
              '&:hover': {
                backgroundImage: 'none',
                backgroundColor: brand[500],
                boxShadow: `0 4px 12px ${alpha(brand[500], 0.45)}`,
              },
              ...
              ...theme.applyStyles('dark', {
                ...
                boxShadow: `inset 0 1px 0 ${brand[300]}, 0 2px 8px ${alpha(brand[700], 0.5)}`,
                border: `1px solid ${brand[600]}`,
                '&:hover': {
                  backgroundImage: 'none',
                  backgroundColor: brand[400],
                  boxShadow: `0 4px 16px ${alpha(brand[500], 0.5)}`,
                },
                '&:active': { backgroundColor: brand[600] },
              }),
            },
